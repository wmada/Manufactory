...
import com.timerchina.manufactory.breaker.CountCircuitBreaker;

/**
 * @author will.ma
 * @date 2017/6/26
 */
public class CountCircuitBreakerTest {

    // 定义熔断器，失败5次进入断开状态
    // 在半断开状态下，连续成功3次，进入闭合状态
    // 1秒后进入半断开状态
    private static AbstractCircuitBreaker breaker = new CountCircuitBreaker(5, 3, 1000);
