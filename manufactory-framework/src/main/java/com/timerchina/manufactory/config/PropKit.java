...
public class PropKit {
    ...
    private static final Map<String, Prop> map  = new HashMap<>();
     ...
     *
     * @see #use(String, Class, String)
     */
    public static Prop use(String fileName, Class<?> callee) {
        return use(fileName, callee, Prop.DEFAULT_ENCODING);
    }
     ...
     */
    public static Prop use(String fileName, Class<?> callee, String encoding) {
        Prop result = map.get(fileName);
        if (result == null) {
            synchronized (map) {
                result = map.get(fileName);
                if (result == null) {
                    result = new Prop(fileName, callee, encoding);
    ...
    public static Prop useless(String fileName) {
        ...
        if (PropKit.prop == previous) PropKit.prop = null;
        return previous;
    }
    ...
    public static Prop getProp() {
        if (prop == null) throw new IllegalStateException("Load properties file by invoking PropKit.use(String fileName) method first.");
        return prop;
    }
